...
class installVpnTorguard():
    ...
    c_vpn_config_dir =  os.path.expanduser("~") + '/.config/torguard_openvpn_config_files'
    ...
    def __init__(self,openvpn_user = None, openvpn_passw = None):
        ...
        if os.path.isfile(web_login_file):
            ...
            print("\n**************************************\n\n")
            print("\nError: No login Credentials found file: 'torguard_login.txt' does not exist in :"  + os.path.expanduser("~") + '/.config/')
